...
If you are deploying for users, read [Self-Hosting Guide](/self-hosting) and the backend Docker Compose workflow in [backend/README.md](https://github.com/zentra-chat/server).
